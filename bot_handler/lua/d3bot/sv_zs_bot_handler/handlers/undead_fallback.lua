...
HANDLER.BotClasses = {
	...
	"Warlock Zombie", "Warlock Zombie", "Warlock Zombie",
	"Poison Zombie", "Poison Zombie", "Poison Zombie",
	"Lacerator",  "Lacerator",  "Lacerator", 
	"Eradicator", "Eradicator", "Eradicator", 
	"Father Gregori", "Father Gregori", "Father Gregori",
	"Pheonix", "Pheonix", "Pheonix",
	"Mech Dog", "Mech Dog", "Mech Dog",
	"Ice Pheonix", 	"Ice Pheonix", 	"Ice Pheonix",
	"Scorpio", "Scorpio", "Scorpio",
	"Chem Zombie", "Chem Zombie", "Chem Zombie", 
	"Night Owl", "Night Owl", "Night Owl", 
	"Hulking Zombie", "Hulking Zombie", "Hulking Zombie",
