...
net.Receive("RTV_Delay", function()
    chat.AddText(Color( 255,177,51), "[Metro Space]", Color( 180,2,235), " The vote has been rocked, map vote will begin on round end")
end)
...
function PANEL:Init()
    ...
    self.countDown:SetTextColor(COLOR_GREEN)
...
function PANEL:SetMaps(maps)
    ...
    for k, v in RandomPairs(maps) do
        ...
        button:SetTextColor(COLOR_ORANGE)
