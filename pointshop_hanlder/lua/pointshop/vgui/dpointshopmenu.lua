surface.CreateFont('PS_Heading', { font = 'bahnschrift', size = 64 })
surface.CreateFont('PS_Heading2', { font = 'bahnschrift', size = 24 })
surface.CreateFont('PS_Heading3', { font = 'bahnschrift', size = 19 })
...
surface.CreateFont( "PS_MainCommunityHeading", {
	...
	local MjcBasicPS1SkinColor = {
		...
		CloseButtonHover = Color(0, 0, 0),
		SidePanel = Color(0, 0, 0),
		InfoPanel = Color(0, 0, 0),
		HeaderColor = Color(0, 0, 0),
		CatButtonColor = Color(0, 0, 0),
		CurrentActiveCat = Color(0, 0, 0),
		NotActiveCat = Color(0, 0, 0),
		GivePointsButton = Color(0, 0, 0),
		GivePointsButtonHover = Color(0, 0, 0)
	}
...
vbar:SetWide(0)
	...
	local function createBtn(text, material, panel, align, description)
		...
		panel:Dock(FILL)
		panel.Paint = function(pnl, w, h) surface.SetDrawColor(19, 0, 36) surface.DrawRect(0, 0, w, h) end
