...
if CLIENT then
	...
	killicon.Add(  "mp7_urbhzd",		"vgui/hud/mp7_urbhzdspawn", icol  )
...
sound.Add({
	...
	volume = 		1.0,
	sound = 			"weapons/mp7urbhzd/mp7-1.wav"
})

sound.Add({
	name = 			"urbhzd_MP7.charger",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/mp7urbhzd/mp7_charger.wav"
})

sound.Add({
	name = 			"urbhzd_MP7.magin",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/mp7urbhzd/mp7_magin.wav"
})

sound.Add({
	name = 			"urbhzd_MP7.magout",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/mp7urbhzd/mp7_magin.wav"
})
