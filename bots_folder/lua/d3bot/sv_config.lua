...
D3bot.NodeDamageEnts = {"prop_*turret", "prop_arsenalcrate", "prop_resupply", "prop_constructor", "prop_medstation", "sigil_barricadetower", "sigil_medicaltower", "sigil_pctower", "sigil_ammotower", "sigil_pointstower"}
...
D3bot.ZombiesPerPlayerMax = 3	-- Limits amount of zombies to this zombie/player ratio. (Not including ZombiesCountAddition)
D3bot.ZombiesPerPlayerWave = 3		-- Number of additional bot zombies every wave for every player on the server.
D3bot.ZombiesPerMinute = 0				-- Number of additional bot zombies every minute.
D3bot.ZombiesPerWave = 3				-- Number of additional bot zombies every wave.
...
D3bot.SelfRedeemWaveMax = 3				-- The maximum wave a player can use !human. (Setting it to 2 would allow the players to redeem in the first and second wave)
