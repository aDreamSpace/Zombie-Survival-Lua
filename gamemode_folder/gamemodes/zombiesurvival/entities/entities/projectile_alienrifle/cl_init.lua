...
function ENT:Draw()
	...
	render.SetColorModulation(0.024, 0.733, 0.451)
	render.SuppressEngineLighting(true)
	self:DrawModel()
	render.SuppressEngineLighting(false)
	render.SetColorModulation(0.235, 0.012, 0.718)
	...
	if self:GetVelocity() ~= vector_origin then
		...
		render.DrawSprite(pos, alt and 25 or 50, alt and 25 or 50, Color(88, alt and 242 or 242, 242, 88))
		render.SetMaterial(matGlow)
		render.DrawSprite(pos, alt and 6 or 12, alt and 6 or 12, Color(88, alt and 242 or 242, 88))
		...
		for i=0, 1 do
			...
			particle:SetColor(88, alt and 242 or 242, 76)
		end
...
function ENT:OnRemove()
	...
	for i=0, 19 do
		...
		particle:SetColor(77, alt and 242 or 88, 77)
	end
	for i=0,5 do
		particle = emitter:Add(matGlow, pos)
		particle:SetVelocity(VectorRand() * 5)
		...
		particle:SetRoll(math.Rand(-0.8, 0.8))
		particle:SetRollDelta(math.Rand(-3, 3))
		particle:SetColor(88, 242, 80)
	end
	for i=1, 45 do
		particle = emitter:Add("effects/splash2", pos)
		particle:SetDieTime(0.1)
		particle:SetColor(77, alt and 242 or 255, 88)
		particle:SetStartAlpha(255)
		particle:SetEndAlpha(0)
		particle:SetStartSize(5)
		particle:SetEndSize(0)
