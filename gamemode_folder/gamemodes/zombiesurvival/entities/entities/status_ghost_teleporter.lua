...
local tInfo = {start = nil, endpos = nil, mask = MASK_ALL, mins = Vector(-8, -8, 0), maxs = Vector(8, 8, 0)}
local tracedata = {start = nil, endpos = nil, mask = MASK_ALL}
function ENT:RecalculateValidity()
	...
	tInfo.start = shootpos
	tInfo.endpos = shootpos + owner:GetAimVector() * 48
