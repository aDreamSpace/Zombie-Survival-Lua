...
function ENT:Draw()
	...
	render.SetColorModulation(1, 0.749, 0)
	...
	if self:GetVelocity() ~= vector_origin then
		...
		render.DrawSprite(pos, alt and 25 or 50, alt and 25 or 50, Color(225, 73, 2))
		render.SetMaterial(matGlow)
		render.DrawSprite(pos, alt and 6 or 12, alt and 6 or 12, Color(225, 73, 2))
