	...
	elseif self:GetPouncing() then
		if owner:IsOnGround() or owner:WaterLevel() >= 2 then
			...
			if SERVER and hit then
				owner:EmitSound("physics/flesh/flesh_strider_impact_bullet1.wav", 100, 60)
			end
...
function SWEP:PlayHitSound()
    self.Owner:EmitSound(StriderSounds[math.random(#StriderSounds)])
end
...
function SWEP:StopSwingingSound()
    self.Owner:StopSound(StriderSounds[math.random(#StriderSounds)])
end
