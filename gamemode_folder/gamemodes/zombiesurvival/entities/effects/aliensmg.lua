...
local function CollideCallback(particle, hitpos, hitnormal)
	...
	if math.random(3) == 3 then
		sound.Play("physics/flesh/flesh_squishy_impact_hard"..math.random(4)..".wav", hitpos, 50, math.Rand(160, 170))
	end
...
function EFFECT:Init(data)
	...
	for i = 1, math.random(60, 85) do
		...
		particle:SetColor(math.Rand(25, 30), math.Rand(100, 240), math.Rand(125, 130))
