...
--Convienience function edited by MagicSwap
function EasyButtonText(parent, btnImg, btnX, btnY, text, font, textcolor)
	--create the image button first
	local btn = vgui.Create("DImageButton", parent)
	btn:SetImage(btnImg)
	btn:SetSize(btnX, btnY)
