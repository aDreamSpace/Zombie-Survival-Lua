	...
	if ammo then
		...
		if ammotype and ammocount then
			...
			if desiredgive >= 1 then
				...
				hook.Run("PlayerGetAmmo", plyr, desiredgive, GAMEMODE.AmmoNames[ammotype] or "Unknown", self)
...
meta.PlayEyePoisonedSound = meta.PlayEyePainSound --legacy
