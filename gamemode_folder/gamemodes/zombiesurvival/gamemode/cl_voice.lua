...
function PANEL:Paint( w, h )
	...
	draw.RoundedBoxEx( 4, 0, 0, w, h, Color( self.ply:VoiceVolume() * teamcolor.r, self.ply:VoiceVolume() * teamcolor.g, self.ply:VoiceVolume() * teamcolor.b, 255 ) )
...
local function CreateVoiceVGUI()
	...
	g_VoicePanelList:SetPos( ScrW() - 300, 0 )
