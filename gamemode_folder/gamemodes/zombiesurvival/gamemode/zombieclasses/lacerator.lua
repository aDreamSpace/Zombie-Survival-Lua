...
CLASS.Model = Model("models/player/zombie_lacerator2.mdl") --Model("models/Zombie/Fast.mdl")
...
function CLASS:PlayerFootstep(pl, vFootPos, iFoot, strSoundName, fVolume, pFilter)
	if iFoot == 0 then
		pl:EmitSound(StepLeftSounds[mathrandom(#StepLeftSounds)], 70, mathrandom(50, 60))
	else
		pl:EmitSound(StepRightSounds[mathrandom(#StepRightSounds)], 70, mathrandom(50, 60))
	end
...
CLASS.Icon = "materials/zombiesurvival/killicons2/lacerator.png"
