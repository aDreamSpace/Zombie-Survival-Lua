CLASS.Name = "The Lurker"
CLASS.TranslationName = "class_lurker"
CLASS.Description = "description_lurker"
CLASS.Help = "controls_lurker"

CLASS.Model = Model("models/player/skeleton.mdl") --Model("models/Zombie/Fast.mdl")
...
CLASS.ZTraits = {
	...
	["fclimb"] = {safename = "Fast Climb", cost = 75, desc = "Increases climb speed by 25%"},
	["flunge"] = {safename = "Force Lunge", cost = 125, desc = "Increases force of lunge"},
}
]]
...
CLASS.Icon = "materials/zombiesurvival/killicons2/lurker.png"
...
function CLASS:PrePlayerDraw(pl)
	render.SetColorModulation(0.984, 0.525, 0)
	render.ModelMaterialOverride(matSkin)
end

function CLASS:PostPlayerDraw(pl)
	render.SetColorModulation(0.682, 0.204, 0)
