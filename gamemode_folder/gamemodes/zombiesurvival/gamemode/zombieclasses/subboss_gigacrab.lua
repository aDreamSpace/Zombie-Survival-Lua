CLASS.Name = "Giga Crab"
CLASS.TranslationName = "class_gigacrab"
CLASS.Description = "description_gigacrab"
CLASS.Help = "controls_gigacrab"

CLASS.Model = Model("models/headcrab.mdl")

CLASS.Wave = 0

CLASS.SWEP = "weapon_zs_gigacrab"
CLASS.Disabled = true 
CLASS.Health = 1100
CLASS.Speed = 220
CLASS.JumpPower = 100
...
CLASS.Icon = "materials/zombiesurvival/killicons2/fastheadcrab.png"
...
local matSkin = Material("models/shadertest/shader2")
