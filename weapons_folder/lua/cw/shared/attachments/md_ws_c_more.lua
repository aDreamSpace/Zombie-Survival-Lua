local att = {}
att.name = "md_ws_c_more"
att.displayName = "C-More Tactical Reflex Sight"
att.displayNameShort = "C-More"
att.aimPos = {"WS_CMOREPos", "WS_CMOREAng"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/md_ws_c_more")
	...
	function att:drawReticle()
		...
		diff = self:getDifferenceToAimPos(self.WS_CMOREPos, self.WS_CMOREAng, att._reticleSize)
