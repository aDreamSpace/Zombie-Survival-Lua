local att = {}
att.name = "md_ws_docter"
att.displayName = "Docter Sight"
att.displayNameShort = "Docter"
att.aimPos = {"WS_DocterPos", "WS_DocterAng"}
att.FOVModifier = 15
att.isSight = true
att.colorType = CustomizableWeaponry.colorableParts.COLOR_TYPE_SIGHT
att.statModifiers = {
OverallMouseSensMult = -0.025
}

if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/md_ws_docter")
	...
	function att:drawReticle()
		...
		diff = self:getDifferenceToAimPos(self.WS_DocterPos, self.WS_DocterAng, att._reticleSize)
