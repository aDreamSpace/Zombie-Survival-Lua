local att = {}
att.name = "md_50cal_scope"
att.displayName = "Modern Warfare 3 .50 Cal Scope"
att.displayNameShort = "50cal"
att.aimPos = {"B50CSPos", "B50CSAng"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/icons/50cal_scope")
	...
	[3] = {t = "Can be seriously messy at close range.", c = CustomizableWeaponry.textColors.NEGATIVE}}

	local old, x, y, ang
	local reticle = surface.GetTextureID("atts/mw3sreticle")
	...
	function att:drawRenderTarget()
		...
		ang:RotateAroundAxis(ang:Right(), self.B50CSAxisAlign.right)
		ang:RotateAroundAxis(ang:Up(), self.B50CSAxisAlign.up)
		ang:RotateAroundAxis(ang:Forward(), self.B50CSAxisAlign.forward)
