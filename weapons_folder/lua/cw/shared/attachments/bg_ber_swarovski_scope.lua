local att = {}
att.name = "bg_ber_swarovski_scope"
att.displayName = "SWAROVSKI Scope"
att.displayNameShort = "Scope"
att.isBG = true
att.isSight = true
att.aimPos = {"SWAROVSKIScopePos", "SWAROVSKIScopeAng"}
att.withoutRail = true

att.statModifiers = {OverallMouseSensMult = -0.1}

if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/aug_scoop")
	att.description = {[1] = {t = "Provides 1.5x magnification.", c = CustomizableWeaponry.textColors.POSITIVE},
...
function att:attachFunc()
	...
	self:setBodygroup(self.SightBGs.main, self.SightBGs.swarovski)
