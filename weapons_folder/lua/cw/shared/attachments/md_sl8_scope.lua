local att = {}
att.name = "md_sl8_scope"
att.displayName = "SL8 Scope"
att.displayNameShort = "SL8 Scope"
att.aimPos = {"HKSL8Pos", "HKSL8Ang"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/icons/sl8_scope")
	...
	[3] = {t = "Maybe/Maybe Not so good up at close range.", c = CustomizableWeaponry.textColors.NEGATIVE}}
	...
	function att:drawRenderTarget()
		...
		ang:RotateAroundAxis(ang:Right(), self.HKSL8AxisAlign.right)
		ang:RotateAroundAxis(ang:Up(), self.HKSL8AxisAlign.up)
		ang:RotateAroundAxis(ang:Forward(), self.HKSL8AxisAlign.forward)
