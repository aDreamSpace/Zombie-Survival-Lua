local att = {}
att.name = "md_scout_scope"
att.displayName = "Steyr Scout Scope"
att.displayNameShort = "Scout Scope"
att.aimPos = {"ScoutPos", "ScoutAng"}
att.FOVModifier = 45
att.isSight = true
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/icons/scout_scope")
	...
	[3] = {t = "Can't really Bonk em at close range.", c = CustomizableWeaponry.textColors.NEGATIVE}}

	local old, x, y, ang
	local reticle = surface.GetTextureID("atts/l115a3scope")
	...
	function att:drawRenderTarget()
		...
		ang:RotateAroundAxis(ang:Right(), self.ScoutAxisAlign.right)
		ang:RotateAroundAxis(ang:Up(), self.ScoutAxisAlign.up)
		ang:RotateAroundAxis(ang:Forward(), self.ScoutAxisAlign.forward)
