...
CustomizableWeaponry.giveAllAttachmentsOnSpawn = 0 -- set to 0 to disable all attachments on spawn
...
--custom functions because UUUUEAAG
CustomizableWeaponry:registerRecognizedStat("MagMult", "Decreases magazine size", "Increases magazine size", CustomizableWeaponry.textColors.NEGATIVE, CustomizableWeaponry.textColors.POSITIVE)
CustomizableWeaponry:registerRecognizedStat("SpeedDecMult", "Decreases movement speed", "Increases movement speed", CustomizableWeaponry.textColors.NEGATIVE, CustomizableWeaponry.textColors.POSITIVE)
CustomizableWeaponry:registerRecognizedStat("ShotsMult", "Decreases amount of shots", "Increases amount of shots", CustomizableWeaponry.textColors.NEGATIVE, CustomizableWeaponry.textColors.POSITIVE)
CustomizableWeaponry:registerRecognizedStat("AuraRangeMult", "Decreases aura range", "Increases aura range", CustomizableWeaponry.textColors.POSITIVE, CustomizableWeaponry.textColors.NEGATIVE)
