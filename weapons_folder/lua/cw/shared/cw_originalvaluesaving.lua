...
CustomizableWeaponry.originalValue:add("SpeedDec", true)
CustomizableWeaponry.originalValue:add("Mag", true)
CustomizableWeaponry.originalValue:add("Shots", true)
CustomizableWeaponry.originalValue:add("AuraRange", true)
