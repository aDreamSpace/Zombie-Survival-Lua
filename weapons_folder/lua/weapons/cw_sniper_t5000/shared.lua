...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 341.7 * 39.37
...
SWEP.Attachments = {[1] = {header = "Optic", offset = {400, -400},  atts = {"md_microt1kh","odec3d_cmore_kry","md_fas2_eotech","md_fas2_aimpoint","md_shortdot","md_uecw_csgo_acog","md_nxs"}},
[2] = {header = "Bipod", offset = {-600, -200},  atts = {"bg_bipod"}},
[3] = {header = "Magazine Upgrade", offset = {-200, -450}, atts = {"a_zsmagssniper1", "a_zsmagssniper2", "a_zsmagssniper3"}},
...
["+reload"] = {header = "Ammo", offset = {-600, 70}, atts = {"am_416barrett", "am_magnum2", "am_matchgrade2", "am_heavyhandload2", "am_grapeshot2", "am_rifdepleteduranium2", "am_ricochet2"}}}
...
function SWEP:IndividualThink()
	self.EffectiveRange = 341.7 * 39.37
	self.DamageFallOff = .21
	
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 51.17 * 39.37))
