...
SWEP.Attachments = {
	...
	{header = "Misc", offset = {-500, 200}, atts = {"md_anpeq15"}},
	[1] = {header = "Magazine Upgrade", offset = {-200, 250}, atts = {"a_zsmagssniper1", "a_zsmagssniper2", "a_zsmagssniper3"}},
	["+reload"] = {header = "Ammo", offset = {-600, -200}, atts = {"am_416barrett", "am_magnum2", "am_matchgrade2", "am_heavyhandload2", "am_grapeshot2", "am_rifdepleteduranium2", "am_ricochet2", "am_reducedpowderload2"}}}
