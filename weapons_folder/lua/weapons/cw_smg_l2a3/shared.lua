...
SWEP.Attachments = {[1] = {header = "Optic", offset = {500, -200}, atts = {"md_microt1kh", "odec3d_cmore_kry", "md_fas2_eotech"}},
[2] = {header = "Barrel", offset = {-500, -320}, atts = {"md_saker222"}},
[3] = {header = "Magazine Upgrade", offset = {-100, -450}, atts = {"a_zsmagsmg1", "a_zsmagsmg2", "a_zsmagsmg3"}},
...
["+reload"] = {header = "Ammo", offset = {-300, 0}, atts = {"am_magnum2", "am_matchgrade2", "am_duplex2", "am_ricochet2", "am_tracers2", "am_luckylast2", "am_rifdepleteduranium2"}}}
