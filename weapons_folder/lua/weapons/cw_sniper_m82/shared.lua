...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 419.6 * 39.37
...
SWEP.Attachments = {[1] = {header = "Optic", offset = {600, -100},  atts = {"md_microt1kh","odec3d_cmore_kry","md_fas2_eotech","md_fas2_aimpoint", "md_schmidt_shortdot", "md_uecw_csgo_acog", "md_nightforce_nxs"}},
 ...
 [3] = {header = "Magazine Upgrade", offset = {-400, 150}, atts = {"a_zsmagssniper1", "a_zsmagssniper2", "a_zsmagssniper3"}},
["+reload"] = {header = "Ammo", offset = {-600, -200}, atts = {"am_416barrett", "am_magnum2", "am_matchgrade2", "am_heavyhandload2", "am_grapeshot2", "am_rifdepleteduranium2", "am_ricochet2", }}}
...
function SWEP:IndividualThink()
	self.EffectiveRange = 419.6 * 39.37
