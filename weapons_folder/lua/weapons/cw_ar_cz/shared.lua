...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 150.4 * 39.37
...
SWEP.Attachments = {[3] = {header = "Sight", offset = {600, -400},  atts = {"odec3d_cmore_kry", "md_fas2_eotech", "md_fas2_aimpoint", "md_schmidt_shortdot", "md_uecw_csgo_acog"}},
	...
	["+reload"] = {header = "Ammo", offset = {-450, 350}, atts = {}}}
...
function SWEP:IndividualThink()
	self.EffectiveRange = 150.4 * 39.37
	self.DamageFallOff = .35
	
	if self.ActiveAttachments.md_pbs12 then
	self.EffectiveRange = ((self.EffectiveRange - 45.12 * 39.37))
	end
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 30.08 * 39.37))
