...
SWEP.Attachments = {[1] = {header = "Sight", offset = {100, -600},  atts = {"md_uecw_foldsight", "md_microt1", "md_cmore", "md_reflex", "md_trijicon", "md_eotech", "md_aimpoint", "md_elcan", "md_acog_fixed", "md_uecw_csgo_acog"}, exclusions = {bg_ris = true, bg_longbarrel = true}},
	...
	[4] = {header = "Rail", offset = {400, 400}, atts = {"md_anpeq15"}},
	[5] = {header = "Magazine Upgrade", offset = {-300, 350}, atts = {"a_zsmagar1", "a_zsmagar2", "a_zsmagar3"}},
	[6] = {header = "Perks", offset = {100, -350}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap", "Perk_Stopping_Power"}},
