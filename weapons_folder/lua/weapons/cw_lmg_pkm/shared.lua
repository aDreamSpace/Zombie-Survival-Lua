...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 228.2 * 39.37
...
SWEP.Attachments = {[1] = {header = "Optic", offset = {700, -350},  atts = {"md_fas2_eotech", "md_fas2_aimpoint", "md_uecw_csgo_acog"}},
    [2] = {header = "Laser", offset = {-650, -300}, atts = {"md_anpeq15"}},
	[3] = {header = "Barrel", offset = {200, -400}, atts = {"md_pbs12"}},
	[4] = {header = "Handguard", offset = {-600, 200}, atts = {"md_foregrip"}},
	[5] = {header = "Bullet Belts", offset = {-200, 0}, atts = {"a_zsmagslmg1", "a_zsmagslmg2", "a_zsmagslmg3"}},
	[6] = {header = "Perks", offset = {400, 300}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap"}},
...
function SWEP:IndividualThink()
	self.EffectiveRange = 228.2 * 39.37
	self.DamageFallOff = .26
	
	if self.ActiveAttachments.md_pbs12 then
	self.EffectiveRange = ((self.EffectiveRange - 68.46 * 39.37))
	end
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 34.23 * 39.37))
