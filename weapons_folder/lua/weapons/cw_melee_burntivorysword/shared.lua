...
if CLIENT then
	...
	SWEP.PrintName = "Burnt Ivory Sword"
...
SWEP.WorldModel = "models/demonssouls/weapons/soulbrandt.mdl"
SWEP.DrawTraditionalWorldModel = false
SWEP.WM = "models/demonssouls/weapons/soulbrandt.mdl"
...
SWEP.PrimaryAttackDamage = {206,242} --{275, 325}
SWEP.SecondaryAttackDamage = {262,337}--{350, 450}
