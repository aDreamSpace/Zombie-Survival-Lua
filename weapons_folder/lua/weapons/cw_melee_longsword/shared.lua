...
SWEP.WorldModel = "models/demonssouls/weapons/long sword.mdl"
SWEP.DrawTraditionalWorldModel = false
SWEP.WM = "models/demonssouls/weapons/long sword.mdl"
...
SWEP.PrimaryAttackDamage = {350,450}--{650, 750}
SWEP.SecondaryAttackDamage = {500, 550}
