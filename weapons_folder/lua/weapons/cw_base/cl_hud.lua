surface.CreateFont("CW_HUD72", {font = "typenoksidi", size = 72, weight = 700, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD60", {font = "typenoksidi", size = 60, weight = 700, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD52", {font = "typenoksidi", size = 52, weight = 700, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD48", {font = "typenoksidi", size = 48, weight = 700, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD40", {font = "typenoksidi", size = 40, weight = 700, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD38", {font = "typenoksidi", size = 38, weight = 700, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD36", {font = "typenoksidi", size = 36, weight = 700, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD32", {font = "typenoksidi", size = 32, weight = 700, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD28", {font = "typenoksidi", size = 28, weight = 700, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD24", {font = "typenoksidi", size = 24, weight = 500, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD22", {font = "typenoksidi", size = 22, weight = 500, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD20", {font = "typenoksidi", size = 20, weight = 500, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD16", {font = "typenoksidi", size = 16, weight = 500, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD14", {font = "typenoksidi", size = 14, weight = 500, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("CW_HUD12", {font = "typenoksidi", size = 12, weight = 500, blursize = 0, antialias = true, shadow = false})
...
function SWEP:DrawHUD()
	if self.CW20Melee then --handle our cw melee test functions then return if we have a cw 20 melee weapon
	...
	if self.dt.State == CW_AIMING then
		...
		if (self.dt.M203Active and (not self.M203Chamber or CustomizableWeaponry.grenadeTypes:canUseProperSights(self.Grenade40MM))) or not self.dt.M203Active or 
		(self.dt.GP25Active and (not self.GP25Chamber or CustomizableWeaponry.grenadeTypes:canUseProperSights(self.Grenade40MM))) or not self.dt.GP25Active
		then
	...
	if not disableCrosshair then
		if self.CrosshairEnabled and GetConVarNumber("cw_crosshair") > 0 then
			...
			if self.dt.GP25Active and self.GP25Chamber then
				local curGrenade = CustomizableWeaponry.grenadeTypes:get(self.Grenade40MM)
				...
				if curGrenade and curGrenade.clumpSpread and self.GP25Chamber then
					self:drawClumpSpread(x2, y2, curGrenade.clumpSpread, self.CrossAlpha * 0.35)
				end
			end
	...
	if not disableCustomHUD then
		local customHUD = true
		
		if not customHUD and GetConVarNumber("gc_3dhud_ammo") <= 0 then
			...
			if self.dt.GP25Active then
				...
				if not self.GP25Chamber then
					draw.ShadowText("GP25 EMPTY", cwhud24, x * 0.5, y - 170, self.HUDColors.red, self.HUDColors.black, 1, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
				else
					draw.ShadowText("GP25 READY", cwhud24, x * 0.5, y - 170, self.HUDColors.white, self.HUDColors.black, 1, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
				end
...
function SWEP:drawCustomHUD()
	...
	if GetConVarNumber("gc_3dhud_ammo") == 0 then
		...
		if self.dt.GP25Active then
			...
			if not self.GP25Chamber then
				draw.ShadowText("GP25 EMPTY", cwhud24, baseXAMMO + 15, baseY - 80, self.HUDColors.red, self.HUDColors.black, 1, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
			else
				draw.ShadowText("GP25 READY", cwhud24, baseXAMMO + 15, baseY - 80, self.HUDColors.white, self.HUDColors.black, 1, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
			end
		...
		draw.ShadowText(zsammotbl[self.Primary.Ammo] or self.Primary.Ammo, cwhud14, baseXAMMO + 15, baseYAMMO + 62, White, Black, 1, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
	end
end
--[[
