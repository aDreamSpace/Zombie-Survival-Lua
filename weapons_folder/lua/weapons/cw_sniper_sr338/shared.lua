...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 320.1 * 39.37
...
SWEP.Attachments = {[1] = {header = "Optic", offset = {600, -400},  atts = {"md_microt1kh","odec3d_cmore_kry","md_fas2_eotech","md_fas2_aimpoint", "md_uecw_csgo_acog", "md_nxs"}},
[2] = {header = "Barrel", offset = {180, -400}, atts = {"md_saker222"}},
[3] = {header = "Handguard", offset = {-650, 100}, atts = {"md_foregrip","md_bipod"}},
[4] = {header = "Rail", offset = {-550, -350}, atts = {"md_anpeq15"}},
[5] = {header = "Magazine Upgrade", offset = {-200, -50}, atts = {"a_zsmagssniper1", "a_zsmagssniper2", "a_zsmagssniper3"}},
 [6] = {header = "Perks", offset = {100, 300}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap", "Perk_Stopping_Power"}},
...
function SWEP:IndividualThink()
	self.EffectiveRange = 320.1 * 39.37
	self.DamageFallOff = .21
	
	if self.ActiveAttachments.md_saker222 then
	self.EffectiveRange = ((self.EffectiveRange - 96.03 * 39.37))
	end
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 48.1 * 39.37))
