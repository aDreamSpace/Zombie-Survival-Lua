...
SWEP.WorldModel = "models/demonssouls/weapons/mail breaker.mdl"
SWEP.DrawTraditionalWorldModel = false
SWEP.WM = "models/demonssouls/weapons/mail breaker.mdl"
...
SWEP.PrimaryAttackDamage = {159, 160}
SWEP.SecondaryAttackDamage = {219, 220}

SWEP.CanBackstab = true
SWEP.BackstabDamageMultiplier = 2
