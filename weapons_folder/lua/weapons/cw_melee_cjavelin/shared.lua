...
SWEP.WorldModel = "models/demonssouls/weapons/cut javelin.mdl"
SWEP.WM = "models/demonssouls/weapons/cut javelin.mdl"
...
SWEP.SecondaryAttackDelay = 2.3

SWEP.FireAnimSpeed = 1.4
SWEP.FireAnimSpeedSecondary = 1.5

SWEP.PrimaryAttackDamage = {104, 105}
SWEP.SecondaryAttackDamage = {169, 170}

SWEP.PrimaryAttackRange = 105
...
SWEP.SecondaryAttackImpactTime = 1.1
