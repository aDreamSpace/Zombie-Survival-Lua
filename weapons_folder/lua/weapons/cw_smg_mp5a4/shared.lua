...
[3] = {header = "Handguard", offset = {-550, -90}, atts = {"md_foregrip"}},
[4] = {header = "Magazine Upgrade", offset = {-700, 250}, atts = {"a_zsmagsmg1", "a_zsmagsmg2", "a_zsmagsmg3"}},
   [5] = {header = "Perks", offset = {100, 0}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap", "Perk_Stopping_Power"}},
...
function SWEP:IndividualThink()
	...
	self.EffectiveRange = ((self.EffectiveRange - 18.7 * 39.37))
	end
