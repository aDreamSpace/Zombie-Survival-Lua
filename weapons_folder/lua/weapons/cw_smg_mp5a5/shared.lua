...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 62 * 39.37
...
SWEP.Attachments = {[1] = {header = "Optic", offset = {300, -300}, atts = {"md_microt1kh", "odec3d_cmore_kry", "md_fas2_eotech", "md_fas2_aimpoint"}},
[2] = {header = "Barrel", offset = {-300, -550}, atts = {"md_rugersup"}},
[3] = {header = "Handguard", offset = {-550, 150}, atts = {"md_foregrip"}},
[4] = {header = "Magazine", offset = {-700, -300}, atts = {"md_extmag22"}},
[5] = {header = "Magazine Upgrade", offset = {-300, -250}, atts = {"a_zsmagsmg1", "a_zsmagsmg2", "a_zsmagsmg3"}},
   [6] = {header = "Perks", offset = {100, 100}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap", "Perk_Stopping_Power"}},
["+reload"] = {header = "Ammo", offset = {-50, 350}, atts = {"am_magnum2", "am_matchgrade2", "am_duplex2", "am_ricochet2", "am_tracers2", "am_luckylast2", "am_rifdepleteduranium2"}}}
