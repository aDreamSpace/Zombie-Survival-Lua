...
SWEP.WorldModel = "models/demonssouls/weapons/demonbrandt.mdl"
SWEP.DrawTraditionalWorldModel = false
SWEP.WM = "models/demonssouls/weapons/demonbrandt.mdl"
...
SWEP.PrimaryAttackDamage = {112,150}--{150, 200}
