...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_anpeq15"] = {model = "models/cw2/attachments/pistollaser.mdl", bone = "Object007", pos = Vector(0.034, 0.37, 0.767), angle = Angle(0, -90, 0), size = Vector(0.14, 0.14, 0.14)}
	}
...
SWEP.Attachments = {[1] = {header = "Barrel", offset = {-350, -200}, atts = {"md_saker"}},
	...
	[3] = {header = "Rail", offset = {-350, 200}, atts = {"md_anpeq15"}},
	["+reload"] = {header = "Bullet Types", offset = {800, 100}, atts = {}}}
