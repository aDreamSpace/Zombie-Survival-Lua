...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 420.69 * 39.37
...
SWEP.Attachments = {[1] = {header = "Optic", offset = {600, -200},  atts = {"md_fas2_aimpoint", "md_schmidt_shortdot", "md_uecw_csgo_acog", "md_nightforce_nxs"}},
[2] = {header = "Bipod", offset = {-600, -200},  atts = {"bg_bipod"}},
[3] = {header = "Magazine Upgrade", offset = {-500, 450}, atts = {"a_zsmagssniper1", "a_zsmagssniper2", "a_zsmagssniper3"}},
...
["+reload"] = {header = "Ammo", offset = {-600, 100}, atts = {"am_416barrett", "am_magnum2", "am_matchgrade2", "am_heavyhandload2", "am_grapeshot2", "am_rifdepleteduranium2", "am_ricochet2"}}}
...
function SWEP:IndividualThink()
	self.EffectiveRange = 420.69 * 39.37
