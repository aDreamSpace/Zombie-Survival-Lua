...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 341.16 * 39.37
...
SWEP.Attachments = {[1] = {header = "Sight", offset = {600, -300},  atts = {"md_microt1", "md_eotech", "md_aimpoint", "md_csgo_acog", "md_csgo_scope_ssg", "md_fas2_leupold", "md_m98b_scope"}},
	...
	[3] = {header = "Perks", offset = {100, 600}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap", "Perk_Stopping_Power"}},
	[4] = {header = "Rail", offset = {0, -400}, atts = {"md_anpeq15"}},
	[5] = {header = "Magazine Upgrade", offset = {-200, 250}, atts = {"a_zsmagssniper1", "a_zsmagssniper2", "a_zsmagssniper3"}},
	--["+attack2"] = {header = "Perks", offset = {-500, 500}, atts = {"pk_sleightofhand", "pk_light"}},
["+reload"] = {header = "Ammo", offset = {400, 100}, atts = {"am_416barrett", "am_magnum2", "am_matchgrade2", "am_heavyhandload2", "am_grapeshot2", "am_rifdepleteduranium2", "am_ricochet2"}}}
...
function SWEP:IndividualThink()
	self.EffectiveRange = 341.16 * 39.37
	self.DamageFallOff = .21
	
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 51.174 * 39.37))
