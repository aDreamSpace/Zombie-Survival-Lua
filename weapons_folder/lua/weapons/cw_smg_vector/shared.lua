...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 81.2 * 39.37
...
SWEP.Attachments = {[1] = {header = "Sight", offset = {500, -550}, atts = {"md_microt1kh", "odec3d_cmore_kry", "md_fas2_eotech", "md_fas2_aimpoint"}},
[2] = {header = "Barrel", offset = {-500, -250}, atts = {"md_cobram22"}},
[3] = {header = "Rail", offset = {-150, -520}, atts = {"md_anpeq15"}},
[4] = {header = "Magazine Upgrade", offset = {-400, 150}, atts = {"a_zsmagsmg1", "a_zsmagsmg2", "a_zsmagsmg3"}},
...
SWEP.MaxSpreadInc = 0.016
SWEP.SpreadPerShot = 0.003
SWEP.SpreadCooldown = 60/500
SWEP.Shots = 1
SWEP.Damage = 55
SWEP.DeployTime = 0.3
...
function SWEP:IndividualThink()
	self.EffectiveRange = 81.2 * 39.37
	self.DamageFallOff = .47
	
	if self.ActiveAttachments.md_cobram22 then
	self.EffectiveRange = ((self.EffectiveRange - 20.3 * 39.37))
	end
