...
SWEP.WorldModel = "models/demonssouls/weapons/baby's nail.mdl"
SWEP.DrawTraditionalWorldModel = false
SWEP.WM = "models/demonssouls/weapons/baby's nail.mdl"
...
SWEP.PrimaryAttackDamage = {179, 180}
