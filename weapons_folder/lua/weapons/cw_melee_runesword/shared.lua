...
SWEP.Animations = {
	...
	windupR = "ready1",
	windupL = "ready2",
	miss_primaryR = "swing1",
	miss_primaryL = "swing2",
	hit_primaryR = "hit1",
	hit_primaryL = "hit2",
...
SWEP.Sounds = {
	["ready1"] = {{time = 0, sound = "CW_FOLEY_MEDIUM"}},
	["ready2"] = {{time = 0, sound = "CW_FOLEY_MEDIUM"}},
	["swing1"] = {{time = 0.2, sound = "CW_FOLEY_MEDIUM"}, {time = 0.15, sound = "CW_SWORD_SLASH_QUICK"}},
	["swing2"] = {{time = 0.2, sound = "CW_FOLEY_MEDIUM"}, {time = 0.15, sound = "CW_SWORD_SLASH_QUICK"}},
...
SWEP.WorldModel = "models/demonssouls/weapons/rune sword.mdl"
SWEP.DrawTraditionalWorldModel = false
SWEP.WM = "models/demonssouls/weapons/rune sword.mdl"
...
SWEP.PrimaryAttackDamage = {1099, 1100}
SWEP.SecondaryAttackDamage = {1499, 1500}
