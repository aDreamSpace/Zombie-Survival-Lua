local panel = vgui.GetControlTable("DComboBox")
panel.Paint = function() end
--hacky solution but i wasnt about to edit every option
...
function MakepOptions()
	...
	dropdown.OnSelect = function(me, index, value, data)
		RunConsoleCommand("gc_3dhud_ammo", value == "2D" and 0 or 1)
	end
	dropdown:SetText(cvars.Number("gc_3dhud_ammo", 1) == 1 and "3D" or "2D")
