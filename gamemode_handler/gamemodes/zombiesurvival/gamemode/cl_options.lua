...
GM.ItemCategoryIcons = {
	...
	[ITEMCAT_PISTOL] = "icon16/add.png",
	[ITEMCAT_SMG] = "icon16/add.png",
	[ITEMCAT_AR] = "icon16/add.png",
	[ITEMCAT_SHOTGUN] = "icon16/add.png",
	[ITEMCAT_RIFLE] = "icon16/add.png",
	[ITEMCAT_BR] = "icon16/add.png",
	[ITEMCAT_MG] = "icon16/add.png",
	[ITEMCAT_VANILLA] = "icon16/joystick_add.png",
	[ITEMCAT_VMELEE] = "icon16/cog.png", 
	[ITEMCAT_PULSE] = "icon16/lightning.png",
	[ITEMCAT_AMMO] = "icon16/cog_go.png",
	[ITEMCAT_MELEE] = "icon16/wand.png",
	[ITEMCAT_TOOLS] = "icon16/wrench.png",
	[ITEMCAT_OTHER] = "icon16/cog_add.png",
	[ITEMCAT_TRAITS] = "icon16/ruby_gear.png",
	[ITEMCAT_RETURNS] = "icon16/user_delete.png",
	[ITEMCAT_ATT] = "icon16/joystick_add.png"
}
...
GM.WeaponStatBarVals = {
	...
	{"SpeedDec", "Speed Decrease", -50, 100, false}
}
