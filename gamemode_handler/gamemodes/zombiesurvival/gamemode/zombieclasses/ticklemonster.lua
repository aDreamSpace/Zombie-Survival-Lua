...
CLASS.Model = Model("models/siren_head_player_jq1991.mdl")
...
CLASS.Icon = "materials/zombiesurvival/killicons2/ticklemonster.png"

function CLASS:PrePlayerDraw(pl)
	render.SetColorModulation(0.5, 0.1, 0.2)
end
