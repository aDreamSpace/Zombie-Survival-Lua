...
ENT.ExplosiveName = "prop_slam"
ENT.DetonatorName = "weapon_zs_slamremote"
...
function ENT:Explode()
	...
	if owner:IsValid() and owner:IsPlayer() and owner:Team() == TEAM_HUMAN then
		...
		util.BlastDamage2(self, owner, pos, self.ExplosionRadius, self.ExplosionDamage)
