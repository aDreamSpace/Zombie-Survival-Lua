...
function ENT:Draw()
	...
	render.SetColorModulation(0.369, 0, 0.596)
	...
	if self:GetVelocity() ~= vector_origin then
		...
		render.DrawSprite(pos, alt and 25 or 50, alt and 25 or 50, Color(181, 1, 208))
		render.SetMaterial(matGlow)
		render.DrawSprite(pos, alt and 6 or 12, alt and 6 or 12, Color(181, 1, 208))
		...
		for i=0, 1 do
			...
			particle:SetColor(77, 1, 208 or 76)
		end
