...
function SWEP:StopMoaningSound()
    self.Owner:StopSound("NPC_BaseZombie.Moan1")
    self.Owner:StopSound("NPC_BaseZombie.Moan2")
    self.Owner:StopSound("NPC_BaseZombie.Moan3")
    self.Owner:StopSound("NPC_BaseZombie.Moan4")
end
...
function SWEP:IsSwinging()
    return self:GetSwingEndTime() > CurTime()
end
