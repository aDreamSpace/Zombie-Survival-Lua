...
local function setmsg(self)
	RunConsoleCommand("setmessagebeacon", self:GetParent().TEntry:GetText())
	self:GetParent():Close()
	print(self:GetParent().TEntry:GetText())
end
