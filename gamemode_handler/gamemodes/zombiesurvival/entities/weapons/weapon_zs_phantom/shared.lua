...
function SWEP:StartMoaningSound()
	self.Owner:EmitSound("zsounds/moan/wraith/groan_01.wav")
end

function SWEP:PlayHitSound()
	self.Owner:EmitSound("zsounds/attack/wraith/attack_0"..math.random(1, 3)..".wav", 140, 161)
end

function SWEP:PlayMissSound()
	self.Owner:EmitSound("zsounds/attack/wraith/charged_0"..math.random(1, 2)..".wav", 140, 165)
end

function SWEP:PlayAttackSound()
	self.Owner:EmitSound("zsounds/attack/wraith/charged_03.wave", 150, 172)
end
