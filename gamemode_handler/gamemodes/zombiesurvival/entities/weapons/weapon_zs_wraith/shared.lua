...
function SWEP:PlayHitSound()
	self.Owner:EmitSound("zsounds/attack/wraith/attack_0"..math.random(1, 3)..".wav", 80, 61)
end

function SWEP:PlayMissSound()
	self.Owner:EmitSound("zsounds/attack/wraith/charged_0"..math.random(1, 2)..".wav", 90, 65)
end

function SWEP:PlayAttackSound()
	self.Owner:EmitSound("zsounds/attack/wraith/charged_03.wave", 90, 72)
end
