...
local function Cmd_ViewModel( pl, cmd, args )
	...
	pl:SendLua([[MySelf:GetActiveWeapon().ViewModel = "]]..newmod..[["]])
	//pl:SendLua([[MySelf:GetViewModel():SetModel("]]..newmod..[[")]])
	pl:SendLua([[MySelf:GetViewModel():SetWeaponModel(Model("]]..newmod..[["), Entity(]]..wep:EntIndex()..[[))]])
...
local function Cmd_WorldModel( pl, cmd, args )
	...
	wep:SetModel(newmod)
	pl:SendLua([[MySelf:GetActiveWeapon().CurWorldModel = "]]..newmod..[["]])
	pl:SendLua([[MySelf:GetActiveWeapon():CreateWeaponWorldModel()]])
