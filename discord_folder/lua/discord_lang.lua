...
Discord.Lang = {
	...
	ONLINE_MESSAGE_TITLE = 'The server is online!',
    ONLINE_MESSAGE_DESCRIPTION = 'Connect now to <join_url>!',
    ...
    CHECK_DISCORD = 'Checking discord!',
    RPC_ABORTED = 'Canceling...',
    ...
    JOINED_DISCORD = 'Gracias por entrar a nuestro Discord!',
    JOINED_DISCORD_ALREADY = 'Gracias por entrar al discord! Como no fue tu primera vez no tendras el dinero de recompenza.',
	...
	ACCOUNT_LINKED = 'Your account <tag> was successfully associated!',
    CONNECTIONS_NOT_FOUND = 'Your Steam account was not detected.',
    ...
    SYNCED_RANK_DISCORD = 'Your Discord role was updated to <role>.',
	...
	NO_LINKED_ACCOUNTS = 'You have no account to join!',
    ...
    RATELIMITED = 'You are having connection problems, try in <seconds> seconds.',
    ...
    NO_STEAM_CONNECTIONS = 'You do not have an associated Steam account. Connect your steam account by typing <linkchatcommand> in the chat. ',
    SYNCED_USERGROUP_GMOD = 'Your user group changed to `` <usergroup> ``!',
	...
	CENTER_TEXT = 'Join Discord!',
    CENTER_BELOW_TEXT = 'You will be rewarded with $ 5000 Credits!',
    JOIN_BUTTON = 'Enter',
    ...
    HELP_DESCRIPTION = [[Estado - Información del servidor
...
ss <PLAYER> - Screenshots the specified player]],
    ...
    INVALID_PLAYER = 'Jugador no valido.',
