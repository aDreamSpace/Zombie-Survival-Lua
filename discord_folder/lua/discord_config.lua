Discord.Config = {
	...
	ClientID = '1160985137320833117',
	ClientSecret = 'Jcp7z3na6syICRbxcI_SoNaCE4iGCBw2',
	...
	BotToken = 'MTE2MDk4NTEzNzMyMDgzMzExNw.GunVnr.dUxTA5gQ6yJ42wT0mrp6nvAnCYdUJretHrUd18',
    ...
    Relay = {
        ...
        Channels = {
			Relay = '1185674698244247712',
			Admin = '1181736895340883968',
        },
    ...
    JoinRewards = {
        ...
        RewardFunc = function(ply)
            ply:PS2_AddStandardPoints(55000, "You have been given 55000 Pointshop points!")
        end,
    },
