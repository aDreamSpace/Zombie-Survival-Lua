local att = {}
att.name = "md_ws_barska"
att.displayName = "Barska Electro Sight"
att.displayNameShort = "Barska"
att.aimPos = {"WS_BarskaPos", "WS_BarskaAng"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/md_ws_barska")
	att.description = {[1] = {t = "Provides a bright reticle to ease aiming.", c = CustomizableWeaponry.textColors.POSITIVE}}
	
	att.reticle = "cw2/reticles/White_Snow/barska"
	att._reticleSize = 3.5
	...
	function att:drawReticle()
		...
		diff = self:getDifferenceToAimPos(self.WS_BarskaPos, self.WS_BarskaAng, att._reticleSize)
