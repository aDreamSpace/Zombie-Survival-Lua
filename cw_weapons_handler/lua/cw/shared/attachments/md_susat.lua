local att = {}
att.name = "md_susat"
att.displayName = "SUSAT Scope"
att.displayNameShort = "SUSAT"
att.aimPos = {"SUSATPos", "SUSATAng"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/icons/susat_scope")
	...
	[3] = {t = "Can be a total mess at close range.", c = CustomizableWeaponry.textColors.NEGATIVE}}

	local old, x, y, ang
	local reticle = surface.GetTextureID("atts/susat_reticle")
	...
	function att:drawRenderTarget()
		...
		ang:RotateAroundAxis(ang:Right(), self.SUSATAxisAlign.right)
		ang:RotateAroundAxis(ang:Up(), self.SUSATAxisAlign.up)
		ang:RotateAroundAxis(ang:Forward(), self.SUSATAxisAlign.forward)
