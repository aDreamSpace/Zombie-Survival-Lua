local att = {}
att.name = "md_acogv2"
att.displayName = "Trijicon ACOGv2"
att.displayNameShort = "ACOG"
att.aimPos = {"ACOGV2Pos", "ACOGV2Ang"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	...
	function att:drawRenderTarget()
		...
		ang:RotateAroundAxis(ang:Right(), self.ACOGV2AxisAlign.right)
		ang:RotateAroundAxis(ang:Up(), self.ACOGV2AxisAlign.up)
		ang:RotateAroundAxis(ang:Forward(), self.ACOGV2AxisAlign.forward)
