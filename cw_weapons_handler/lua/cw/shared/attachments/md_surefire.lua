local att = {}
att.name = "md_surefire"
att.displayName = "SUREFIRE"
...
-- ["md_surefire"] = {model = "models/weapons/upgrades/a_flashlight_m9.mdl", bone = "Frame", pos = Vector(-0.021, 5.11, -0.306), angle = Angle(0, -90, 0), size = Vector(0.791, 0.791, 0.791)},
-- ["md_surefire"] = {model = "models/weapons/upgraded/a_flashlight_rail.mdl", bone = "", pos = Vector(5.3, -0.209, 0.561), angle = Angle(0, 0, 180), size = Vector(0.885, 0.885, 0.885)},
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/surefire")
	...
	function att:elementRender()
		local model = self.AttachmentModelsVM.md_surefire.ent
