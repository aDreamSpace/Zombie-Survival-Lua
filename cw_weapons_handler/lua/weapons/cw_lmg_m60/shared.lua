...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 215.7 * 39.37
...
function SWEP:IndividualThink()
	self.EffectiveRange = 215.7 * 39.37
	self.DamageFallOff = .28
	
	if self.ActiveAttachments.md_saker222 then
	self.EffectiveRange = ((self.EffectiveRange - 64.71 * 39.37))
	end
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 32.355 * 39.37))
	self.DamageFallOff = ((self.DamageFallOff - .042))
	end
end
