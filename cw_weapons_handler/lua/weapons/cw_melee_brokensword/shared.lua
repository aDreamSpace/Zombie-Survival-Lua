...
SWEP.WorldModel = "models/demonssouls/weapons/broken sword.mdl"
SWEP.DrawTraditionalWorldModel = false
SWEP.WM = "models/demonssouls/weapons/broken sword.mdl"
...
SWEP.PrimaryAttackDamage = {52, 69}--{45, 90}
SWEP.SecondaryAttackDamage = {85,110}--{140, 160}
