...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 160.6 * 39.37
...
SWEP.Attachments = {[3] = {header = "Sight", offset = {450, -400},  atts = {"md_microt1kh","md_kobra","odec3d_cmore_kry","md_fas2_eotech","md_fas2_aimpoint", "md_schmidt_shortdot", "md_uecw_csgo_acog", "md_pso1"}},
	...
	[1] = {header = "Handguard", offset = {-400, -150}, atts = {"md_foregrip"}},
	 ...
	 [5] = {header = "Magazine Upgrade", offset = {-500, 200}, atts = {"a_zsmagar1", "a_zsmagar2", "a_zsmagar3"}}, 
	["+reload"] = {header = "Ammo", offset = {450, -20}, atts = {"am_highcaliberrounds2", "am_hqb2", "am_magnum2", "am_matchgrade2", "am_luckylast2", "am_duplex2", "am_depleteduranium2"}}}
...
SWEP.VelocitySensitivity = 0.7
SWEP.MaxSpreadInc = 0.014
...
function SWEP:IndividualThink()
	self.EffectiveRange = 160.6 * 39.37
	self.DamageFallOff = .41
	
	if self.ActiveAttachments.md_pbs12 then
	self.EffectiveRange = ((self.EffectiveRange - 40.15 * 39.37))
	end
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 32.12 * 39.37))
