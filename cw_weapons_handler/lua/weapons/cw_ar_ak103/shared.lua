...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 155.2 * 39.37
...
function SWEP:IndividualThink()
	self.EffectiveRange = 155.2 * 39.37
	self.DamageFallOff = .35
	
	if self.ActiveAttachments.md_pbs12 then
	self.EffectiveRange = ((self.EffectiveRange - 38.8 * 39.37))
	end
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 31.04 * 39.37))
	...
	self.DamageFallOff = ((self.DamageFallOff + .035))
	end
end