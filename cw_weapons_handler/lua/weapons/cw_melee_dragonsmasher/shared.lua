...
if CLIENT then
	...
	SWEP.PrintName = "Dragon Bone Smasher"
...
SWEP.WorldModel = "models/demonssouls/weapons/dragon bone smasher.mdl"
SWEP.WM = "models/demonssouls/weapons/dragon bone smasher.mdl"
...
SWEP.PrimaryAttackDamage = {1299, 1300}
SWEP.SecondaryAttackDamage = {1599, 1600}
