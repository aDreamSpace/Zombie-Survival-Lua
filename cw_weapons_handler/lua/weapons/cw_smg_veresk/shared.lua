...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 82.2 * 39.37
...
SWEP.Attachments = {[1] = {header = "Optic", offset = {300, -500}, atts = {"md_microt1kh", "odec3d_cmore_kry", "md_fas2_eotech", "md_fas2_aimpoint"}},
[2] = {header = "Barrel", offset = {-300, -600}, atts = {"md_tundra9mm2"}},
[3] = {header = "Rail", offset = {-625, -200}, atts = {"md_anpeq15"}},
[4] = {header = "Magazine Upgrade", offset = {-500, 150}, atts = {"a_zsmagsmg1", "a_zsmagsmg2", "a_zsmagsmg3"}},
...
["+reload"] = {header = "Ammo", offset = {-50, -150}, atts = {"am_magnum2", "am_matchgrade2", "am_duplex2", "am_ricochet2", "am_tracers2", "am_luckylast2", "am_rifdepleteduranium2"}}}
...
SWEP.MaxSpreadInc = 0.013
SWEP.SpreadPerShot = 0.0028
...
function SWEP:IndividualThink()
	self.EffectiveRange = 82.2 * 39.37
