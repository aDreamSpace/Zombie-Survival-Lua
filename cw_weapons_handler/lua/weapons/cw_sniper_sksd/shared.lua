...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 159.4 * 39.37
	...
	SWEP.IronsightPos = Vector(-1.125, -2, 0.859)
	SWEP.IronsightAng = Vector(.13, 0.01, 0)
...
SWEP.Attachments = {[1] = {header = "Sight", offset = {600, -600},  atts = {"md_kobra", "odec3d_cmore_kry", "md_fas2_eotech", "md_fas2_aimpoint", "md_schmidt_shortdot", "md_uecw_csgo_acog", "md_pso1"}},
	...
	[5] = {header = "Magazine Upgrade", offset = {-50, -50}, atts = {"a_zsmagssniper1", "a_zsmagssniper2", "a_zsmagssniper3"}},
	 [6] = {header = "Perks", offset = {-300, 300}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap", "Perk_Stopping_Power"}},
...
function SWEP:IndividualThink()
	self.EffectiveRange = 159.4 * 39.37
	self.DamageFallOff = .35
	
	if self.ActiveAttachments.md_pbs12 then
	self.EffectiveRange = ((self.EffectiveRange - 47.82 * 39.37))
	end
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 23.9 * 39.37))
