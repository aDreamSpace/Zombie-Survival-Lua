...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 284.25 * 39.37
...
SWEP.Attachments = {[1] = {header = "Sight", offset = {900, -250},  atts = {"bg_hcarfoldsight", "odec3d_cmore_kry", "md_fas2_eotech", "md_fas2_aimpoint", "md_uecw_csgo_acog"}},
    [2] = {header = "Rail", offset = {-350, -500}, atts = {"md_anpeq15"}},
	[3] = {header = "Barrel", offset = {400, -600}, atts = {"md_muzl", "md_saker222"}},
	[4] = {header = "Bolt", offset = {350, -100}, atts = {"md_lightbolt"}},
	[5] = {header = "Handguard", offset = {-700, -150}, atts = {"md_foregrip","md_bipod"}},
	[6] = {header = "Magazine Upgrade", offset = {-300, -150}, atts = {"a_zsmagar1", "a_zsmagar2", "a_zsmagar3"}},
	 [7] = {header = "Perks", offset = {100, 300}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap", "Perk_Stopping_Power"}},
	["+reload"] = {header = "Ammo", offset = {1000, 150}, atts = {"am_highcaliberrounds2", "am_hqb2", "am_magnum2", "am_matchgrade2", "am_luckylast2", "am_duplex2", "am_depleteduranium2"}}}
...
SWEP.ReloadHalt = 2.48
SWEP.ReloadHalt_Empty = 3
SWEP.SnapToIdlePostReload = true


function SWEP:IndividualThink()
	self.EffectiveRange = 284.25 * 39.37
	self.DamageFallOff = .25
	self.RecoilToSpread = .15
	
	if self.ActiveAttachments.md_saker222 then
	self.EffectiveRange = ((self.EffectiveRange - 85.27 * 39.37))
	end
	if self.ActiveAttachments.md_lightbolt then
	self.RecoilToSpread = ((self.RecoilToSpread + .4))
	end
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 42.69 * 39.37))
