...
SWEP.Attachments = {
	...
	[5] = {header = "Accessories", offset = {2000, 450}, atts = {"bg_aa12_ammobag"}},
	[6] = {header = "Frame", offset = {600, 400}, atts = {"bg_aa12_AmmoHolder"}},
	[7] = {header = "Drum Magazines", offset = {300, 750}, atts = {"a_zsmagshotgun1", "a_zsmagshotgun2", "a_zsmagshotgun3"}},
		[8] = {header = "Perks", offset = {100, -100}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap", "Perk_Stopping_Power"}},
	["impulse 100"] = {header = "Cameo", offset = {1100, 450}, atts = {"skin_aa12_digital"}}, //skin_aa12_buster
	
	["+reload"] = {header = "Ammo", offset = {1500, 0}, atts = {"am_flechetterounds2", "am_slugrounds2", "am_shrapnel2", "am_minishells2", "am_sabots2", "am_dragonsbreath2", "am_explosive2", "am_kristallnacht2"}}}
