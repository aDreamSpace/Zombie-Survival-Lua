...
SWEP.WorldModel = "models/demonssouls/weapons/winged spear.mdl"
SWEP.WM = "models/demonssouls/weapons/winged spear.mdl"
...
SWEP.PrimaryAttackDamage = {149, 150}
SWEP.SecondaryAttackDamage = {269, 270}
