...
SWEP.WorldModel = "models/demonssouls/weapons/dagger.mdl"
SWEP.DrawTraditionalWorldModel = false
SWEP.WM = "models/demonssouls/weapons/dagger.mdl"
...
SWEP.PrimaryAttackDelay = 0.7
SWEP.SecondaryAttackDelay = 2.25

SWEP.PrimaryAttackDamage = {79, 80}
...
SWEP.SecondaryAttackRange = 44

SWEP.HolsterTime = 0.3
SWEP.DeployTime = 0.3

SWEP.PrimaryAttackImpactTime = 0.2
SWEP.PrimaryAttackDamageWindow = 0.03
