...
if CLIENT then
	...
	SWEP.EffectiveRange_Orig = 262.1 * 39.37
...
SWEP.Attachments = {[1] = {header = "Optic", offset = {600, -400},  atts = {"md_fas2_aimpoint", "md_schmidt_shortdot", "md_uecw_csgo_acog", "md_nightforce_nxs"}},
[2] = {header = "Barrel", offset = {-600, -300},  atts = {"md_pbs12"}},
[3] = {header = "Conversion", offset = {800, 100},  atts = {"md_avt40"}},
[4] = {header = "Magazine Upgrade", offset = {-400, 350}, atts = {"a_zsmagssniper1", "a_zsmagssniper2", "a_zsmagssniper3"}},
 [5] = {header = "Perks", offset = {100, 400}, atts = {"Cod_Extreme_Conditioning", "Cod_Fast_Hands", "Cod_Steady_Aim", "Perk_Force", "Cod_Double_Tap", "Perk_Stopping_Power"}},
...
SWEP.HipSpread = 0.08
SWEP.AimSpread = 0.0036
SWEP.VelocitySensitivity = .75
SWEP.MaxSpreadInc = 0.022
...
function SWEP:IndividualThink()
	self.EffectiveRange = 262.1 * 39.37
	self.DamageFallOff = .3
	
	if self.ActiveAttachments.md_pbs12 then
	self.EffectiveRange = ((self.EffectiveRange - 78.6 * 39.37))
	end
	if self.ActiveAttachments.am_matchgrade then
	self.EffectiveRange = ((self.EffectiveRange + 39.3 * 39.37))
